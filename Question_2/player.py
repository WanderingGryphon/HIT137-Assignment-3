...
class Player:
    def __init__(self, x, y, width, height, run_animation_images, back_animation_images, jump_animation_images,
                 ...
                 shoot_animation_images, shoot_left_animation_images,jump_sound,shoot_sound):
        self.idle_right_animation_images = [pygame.image.load(os.path.join('images', f'Idle ({i}).png')) for i in
                                           range(1, 10)]
        ...
        self.jump_sound = jump_sound # Jump Sound
        self.shoot_sound = shoot_sound # Shoot Sound
    ...
    def reset(self, enemies):
        ...
        # print(f"Resetting player position from ({self.x}, {self.y})")  # Debug output
        self.x = 115  # Reset x position to starting point
        self.y = 500.0  # Reset y position to starting point (ground level)
        # print(f"Player position after reset: ({self.x}, {self.y})")  # Debug output
        self.health = 200  # Reset health
        ...
        self.on_ground = True  # Ensure the player starts on the ground
